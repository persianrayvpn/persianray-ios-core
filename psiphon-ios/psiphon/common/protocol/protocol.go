...
const (
	...
	TUNNEL_PROTOCOL_FRONTED_MEEK_EDGE                 = "FRONTED-MEEK-EDGE-OSSH"
	TUNNEL_PROTOCOL_FRONTED_MEEK_HTTP                = "FRONTED-MEEK-HTTP-OSSH"
	TUNNEL_PROTOCOL_FRONTED_MEEK_HTTP_EDGE            = "FRONTED-MEEK-EDGE-HTTP-OSSH"
	TUNNEL_PROTOCOL_QUIC_OBFUSCATED_SSH              = "QUIC-OSSH"
	TUNNEL_PROTOCOL_FRONTED_MEEK_QUIC_OBFUSCATED_SSH = "FRONTED-MEEK-QUIC-OSSH"
	TUNNEL_PROTOCOL_FRONTED_MEEK_QUIC_EDGE_OSSH       = "FRONTED-MEEK-EDGE-QUIC-OSSH"
...
func TunnelProtocolIsCompatibleWithInproxy(protocol string) bool {
	...
	return !TunnelProtocolUsesRefractionNetworking(protocol) &&
		!TunnelProtocolUsesFrontedMeekEdge(protocol)
}
...
func TunnelProtocolUsesFrontedMeekEdge(protocol string) bool {
	protocol = TunnelProtocolMinusInproxy(protocol)
	return protocol == TUNNEL_PROTOCOL_FRONTED_MEEK_EDGE ||
		protocol == TUNNEL_PROTOCOL_FRONTED_MEEK_HTTP_EDGE ||
		protocol == TUNNEL_PROTOCOL_FRONTED_MEEK_QUIC_EDGE_OSSH
}
...
func TunnelProtocolBase(protocol string) string {
	...
	if baseProtocol == TUNNEL_PROTOCOL_FRONTED_MEEK_EDGE {
		baseProtocol = TUNNEL_PROTOCOL_FRONTED_MEEK
	} else if baseProtocol == TUNNEL_PROTOCOL_FRONTED_MEEK_HTTP_EDGE {
		baseProtocol = TUNNEL_PROTOCOL_FRONTED_MEEK_HTTP
	} else if baseProtocol == TUNNEL_PROTOCOL_FRONTED_MEEK_QUIC_EDGE_OSSH {
